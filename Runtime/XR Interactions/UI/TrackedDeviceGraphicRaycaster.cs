...
namespace VaporXR.UI
{
    ...
    public class TrackedDeviceGraphicRaycaster : BaseRaycaster, IPokeStateDataProvider, IMultiPokeStateDataProvider
    {
        ...
        /// <summary>
        /// Attempts to get the <see cref="VaporXR.PokeStateData"/> for the provided <see cref="IUIInteractor"/>.
        /// </summary>
        ...
        /// <summary>
        /// Gets the <see cref="VaporXR.PokeStateData"/> as a <see cref="IReadOnlyBindableVariable{TValue}"/> for the target transform.
        /// </summary>
        /// <param name="target">The target to get the <see cref="VaporXR.PokeStateData"/> for.</param>
        /// <returns>Returns a <see cref="IReadOnlyBindableVariable{TValue}"/> for the <see cref="VaporXR.PokeStateData"/> for the target.</returns>
