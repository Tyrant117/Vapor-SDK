...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        VXRInputModalityManager.InputMode m_CurrentInputMode = VXRInputModalityManager.InputMode.None;
        ...
        protected void OnEnable()
        {
            ...
            m_BindingsGroup.AddBinding(VXRInputModalityManager.CurrentInputMode.SubscribeAndUpdate(OnInputModeChanged));
        ...
        void OnInputModeChanged(VXRInputModalityManager.InputMode newInputMode)
        {
        ...
        {
            if (m_CurrentInputMode == VXRInputModalityManager.InputMode.MotionController)
        ...
        {
            if (m_CurrentInputMode == VXRInputModalityManager.InputMode.None)
            {
                m_MenuVisibleBindableVariable.Value = false;
                return;
            }
