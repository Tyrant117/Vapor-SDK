...
namespace VaporXR
{
    ...
    public static class XRInteractionUpdateOrder
    {
        ...
        /// <summary>
        /// Order when <see cref="VXRInteractionManager"/> is updated.
        /// </summary>
        ...
        /// <summary>
        /// Order when instances of type <see cref="VXRInteractorLineVisual"/> are updated.
        /// </summary>
        ...
        /// <summary>
        /// Order when <see cref="VXRInteractionManager.OnBeforeRender"/> is called.
        /// </summary>
        public const int k_BeforeRenderOrder = 100;

        /// <summary>
        /// Order when <see cref="VXRInteractorLineVisual.OnBeforeRenderLineVisual"/> is called.
        /// </summary>
