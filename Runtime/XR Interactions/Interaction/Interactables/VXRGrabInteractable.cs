...
namespace VaporXR
{
    ...
    public class VXRGrabInteractable : VXRBaseInteractable
    {
        ...
        public float velocityDamping { get => m_VelocityDamping; set => m_VelocityDamping = value; }
        ...
        /// <seealso cref="XRBaseInteractable.MovementType.VelocityTracking"/>
        /// <seealso cref="trackPosition"/>
        public float velocityScale { get => m_VelocityScale; set => m_VelocityScale = value; }
        ...
        public float angularVelocityDamping { get => m_AngularVelocityDamping; set => m_AngularVelocityDamping = value; }
        ...
        /// <seealso cref="XRBaseInteractable.MovementType.VelocityTracking"/>
        /// <seealso cref="trackRotation"/>
        public float angularVelocityScale { get => m_AngularVelocityScale; set => m_AngularVelocityScale = value; }
        ...
        public bool trackPosition { get => m_TrackPosition; set => m_TrackPosition = value; }
        ...
        public bool smoothPosition { get => m_SmoothPosition; set => m_SmoothPosition = value; }
        ...
        /// <seealso cref="tightenPosition"/>
        public float smoothPositionAmount { get => m_SmoothPositionAmount; set => m_SmoothPositionAmount = value; }
        ...
        /// <seealso cref="smoothPosition"/>
        /// <seealso cref="smoothPositionAmount"/>
        public float tightenPosition { get => m_TightenPosition; set => m_TightenPosition = value; }
        ...
        /// <seealso cref="trackPosition"/>
        /// <seealso cref="trackScale"/>
        public bool trackRotation { get => m_TrackRotation; set => m_TrackRotation = value; }
        ...
        public bool smoothRotation { get => m_SmoothRotation; set => m_SmoothRotation = value; }
        ...
        /// <seealso cref="tightenRotation"/>
        public float smoothRotationAmount { get => m_SmoothRotationAmount; set => m_SmoothRotationAmount = value; }
        ...
        /// <seealso cref="smoothRotation"/>
        /// <seealso cref="smoothRotationAmount"/>
        public float tightenRotation { get => m_TightenRotation; set => m_TightenRotation = value; }
        ...
        /// <seealso cref="trackPosition"/>
        /// <seealso cref="trackRotation"/>
        public bool trackScale { get => m_TrackScale; set => m_TrackScale = value; }
        ...
        public bool smoothScale { get => m_SmoothScale; set => m_SmoothScale = value; }
        ...
        /// <seealso cref="tightenScale"/>
        public float smoothScaleAmount { get => m_SmoothScaleAmount; set => m_SmoothScaleAmount = value; }
        ...
        /// <seealso cref="smoothScale"/>
        /// <seealso cref="smoothScaleAmount"/>
        public float tightenScale { get => m_TightenScale; set => m_TightenScale = value; }

        /// <summary>
        /// Whether this object inherits the velocity of the Interactor when released.
        /// </summary>
        public bool throwOnDetach { get => m_ThrowOnDetach; set => m_ThrowOnDetach = value; }
        ...
        public float throwSmoothingDuration { get => m_ThrowSmoothingDuration; set => m_ThrowSmoothingDuration = value; }
        ...
        /// <seealso cref="throwOnDetach"/>
        public AnimationCurve throwSmoothingCurve { get => m_ThrowSmoothingCurve; set => m_ThrowSmoothingCurve = value; }

        /// <summary>
        /// Scale factor Unity applies to this object's velocity inherited from the Interactor when released.
        /// </summary>
        /// <seealso cref="throwOnDetach"/>
        public float throwVelocityScale { get => m_ThrowVelocityScale; set => m_ThrowVelocityScale = value; }

        /// <summary>
        /// Scale factor Unity applies to this object's angular velocity inherited from the Interactor when released.
        /// </summary>
        /// <seealso cref="throwOnDetach"/>
        public float throwAngularVelocityScale { get => m_ThrowAngularVelocityScale; set => m_ThrowAngularVelocityScale = value; }

        /// <summary>
        /// Forces this object to have gravity when released
        /// (will still use pre-grab value if this is <see langword="false"/>).
        /// </summary>
        public bool forceGravityOnDetach { get => m_ForceGravityOnDetach; set => m_ForceGravityOnDetach = value; }
        ...
        /// </summary>
        public bool retainTransformParent { get => m_RetainTransformParent; set => m_RetainTransformParent = value; }
        ...
        public bool addDefaultGrabTransformers { get => m_AddDefaultGrabTransformers; set => m_AddDefaultGrabTransformers = value; }
                ...
                if (baseInteractor != null && baseInteractor.SelectedInteractableMovementTypeOverride.HasValue)
                {
                    if (movementTypeOverride.HasValue)
                    {
                        Debug.LogWarning($"Multiple interactors selecting \"{name}\" have different movement type override values set" +
                                         $" ({nameof(VXRBaseInteractor.SelectedInteractableMovementTypeOverride)})." +
