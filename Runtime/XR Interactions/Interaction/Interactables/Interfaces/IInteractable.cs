...
{
    public interface IInteractable : IHoverInteractable, ISelectInteractable
    {
        #region Properties
...
#pragma warning restore IDE1006 // Naming Styles
        ...
        Func<IInteractable, Vector3, DistanceInfo> GetDistanceOverride { get; set; }
        Func<IAttachPoint, Transform> OverrideAttachTransform { get; }
        #endregion
