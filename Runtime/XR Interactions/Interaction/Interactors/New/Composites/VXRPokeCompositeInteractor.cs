...
{
    [RequireComponent(typeof(VXRHoverInteractor))]
    public class VXRPokeCompositeInteractor : VXRCompositeInteractor, IPokeStateDataProvider, IAttachPointVelocityProvider
    {
        ...
        {
            if (Hover.TryGetXROrigin(out var origin))
            {
