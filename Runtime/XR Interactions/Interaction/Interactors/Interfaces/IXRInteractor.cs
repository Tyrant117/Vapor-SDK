...
namespace VaporXR
{
    ...
    //    VXRInteractorBridge Bridge { get; }
    ...
    public static class XRInteractorExtensions
    {
        ...
        public static bool IsBlockedByInteractionWithinGroup(this VXRBaseInteractor interactor)
        {
        ...
        /// <see langword="false"/> otherwise. Always returns <see langword="false"/> if <paramref name="interactor"/>
        /// is not contained within a Group.</returns>
        public static bool IsBlockedByInteractionWithinGroup(this VXRInteractor interactor)
        {
            if (interactor is not IXRGroupMember groupMember)
                return false;
