namespace VaporXR
{
    ...
    /// </remarks>
    /// <seealso cref="VXRInteractionGroup"/>
    ...
    public interface IXRGroupMember
    {
        ...
        /// list or just after the Group has registered with the <see cref="VXRInteractionManager"/>. This method is
        ...
        /// list or before the Group unregisters with the <see cref="VXRInteractionManager"/>. This method is called
