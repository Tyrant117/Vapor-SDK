...
namespace VaporXR
{
    ...
    public interface IXRInteractionGroup
    {
        ...
        /// </remarks>
        /// <seealso cref="VXRInteractionManager.interactionGroupRegistered"/>
        ...
        /// do not hold a reference to it.
        /// </remarks>
        /// <seealso cref="VXRInteractionManager.interactionGroupUnregistered"/>
        ...
        /// </remarks>
        /// <seealso cref="VXRInteractionManager.RegisterInteractionGroup(IXRInteractionGroup)"/>
        void OnRegistered(InteractionGroupRegisteredEventArgs args);

        /// <summary>
        /// The <see cref="VXRInteractionManager"/> calls this method just before this Interaction Group is unregistered from it.
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        /// <seealso cref="VXRInteractionManager.UnregisterInteractionGroup(IXRInteractionGroup)"/>
        void OnBeforeUnregistered();

        /// <summary>
        /// The <see cref="VXRInteractionManager"/> calls this method when this Interaction Group is unregistered from it.
        /// </summary>
        ...
        /// <remarks>
        /// <paramref name="groupMember"/> must implement either <see cref="VXRBaseInteractor"/> or <see cref="IXRInteractionGroup"/>.
        /// </remarks>
        ...
        /// <summary>
        /// The <see cref="VXRInteractionManager"/> calls this method to update interactions for this Group's members.
        /// This is where interaction events occur for any <see cref="VXRBaseInteractor"/> member.
        /// </summary>
        /// <remarks>
        /// The implementation of this method should call <see cref="UpdateGroupMemberInteractions(VXRBaseInteractor, out VXRBaseInteractor)"/>.
        /// </remarks>
