...
namespace VaporXR
{
    ...
    public readonly struct ARTrackablesParentTransformChangedEventArgs : IEquatable<ARTrackablesParentTransformChangedEventArgs>
    {
        ...
        public ARTrackablesParentTransformChangedEventArgs(VXROrigin origin, Transform trackablesParent)
        {
            if (origin == null)
        ...
        public override int GetHashCode() => HashCode.Combine(Origin != null ? Origin.GetHashCode() : 0, TrackablesParent != null ? TrackablesParent.GetHashCode() : 0);
