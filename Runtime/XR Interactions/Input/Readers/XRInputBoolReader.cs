...
namespace VaporXR
{
    ...
    public class XRInputBoolReader : IXRInputValueReader<bool>
    {
...
#pragma warning restore IDE0051 // Remove unused private members
        ...
        private XRInputDeviceBoolValueReader _reader;
        ...
        public bool ReadValue()
        {
            return _inputType switch
            {
                ...
                InputSourceType.ActionReference => TryGetInputActionReference(out var actionReference) ? actionReference.action.ReadValue<bool>() : false,
                _ => false,
            };
        }
        ...
        public float ReadValueAsFloat()
        {
            return _inputType switch
            {
                ...
                InputSourceType.Legacy => _reader.ReadValueAsFloat(),
        ...
        public bool TryReadValue(out bool value)
        {
            ...
            switch (_inputType)
            {
                ...
                case InputSourceType.ActionReference:
                    value = TryGetInputActionReference(out var actionReference) ? actionReference.action.ReadValue<bool>() : false;
                    return true;
                default:
                    return false;
            }
