...
namespace VaporObservables
{
    ...
    /// </summary>
    [Serializable]
    public struct SavedObservableClassOld
    {
        public int Type;
        public int ID;
        public SavedObservableField[] SavedFields;

        public SavedObservableClassOld(int type, int id, List<SavedObservableField> fields)
        {
            Type = type;
            ID = id;
    ...
    /// </summary>
    public abstract class ObservableClassOld
    {
        /// <summary>
        ...
        /// </summary>
        public event Action<ObservableClassOld> Dirtied;

        protected ObservableClassOld(int uniqueId)
        {
            ID = uniqueId;
            IsLoaded = false;
        }

        protected ObservableClassOld(int containerType, int uniqueId)
        {
            Type = containerType;
            ID = uniqueId;
            IsLoaded = false;
        ...
        public SavedObservableClassOld Save()
        {
            ...
            return new SavedObservableClassOld(Type, ID, holder);
        }

        public void Load(SavedObservableClassOld save, bool createMissingFields = true, bool forceReload = false)
        {
