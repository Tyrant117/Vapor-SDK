...
namespace VaporNetcode
{
    ...
    public static class NetworkWriterExtensions
    {
        ...
        public static void WriteArraySegment<T>(this NetworkWriter writer, ArraySegment<T> segment) where T : ISerializablePacket
        {
            int length = segment.Count;
            writer.WriteInt(length);
            for (int i = 0; i < length; i++)
            {
                segment.Array[segment.Offset + i].Serialize(writer);
            }
        }
        ...
        public static void WriteList<T>(this NetworkWriter writer, List<T> list) where T : ISerializablePacket
        {
            if (list is null)
            {
                writer.WriteInt(-1);
        ...
        */
        ...
        public static void WriteArray<T>(this NetworkWriter writer, T[] array) where T : ISerializablePacket
        {
            if (array is null)
            {
                writer.WriteInt(-1);
        ...
        public static void WriteTexture2D(this NetworkWriter writer, Texture2D texture2D)
        {
            ...
            var array = texture2D.GetPixels32();
            if (array is null)
            {
                writer.WriteInt(-1);
                return;
