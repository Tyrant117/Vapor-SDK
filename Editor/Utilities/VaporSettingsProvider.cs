...
namespace VaporEditor
{
    public class VaporSettingsProvider /*: SettingsProvider*/
    {
        ...
        //    var enableNetcodeForGo = new Button()
        //    {
        //        text = "Enable Netcode For GameObjects",
        //        tooltip = "Enables the USE_NETCODE_FOR_GO define allowing for Netcode For GameObjects"
        //    };
        ...
        //private static void EnabledNetcodeForGameObjects()
        //{
