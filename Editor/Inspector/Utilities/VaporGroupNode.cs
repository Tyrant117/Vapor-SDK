...
namespace VaporInspectorEditor
{
    public class VaporGroupNode
    {
        ...
        public bool ShouldDraw => Children.Count > 0 || /*ContainerContent.Count > 0 ||*/ IsLeafNode;
        ...
        public VaporGroupNode(VaporGroupNode parent, VaporGroupAttribute groupAttribute, VisualElement container)
        {
            ...
            if (!IsRootNode)
            {
                AddOrder = Parent.Children.Count;
            }
        }
        ...
        public void AddChild(VaporDrawerInfo info)
        {
            ...
            var childNode = new VaporGroupNode(this, UIGroupType.Vertical, GroupName, info.HasUpdatedOrder ? info.UpdatedOrder : 0, ve)
            {
                IsLeafNode = true
            };
            Children.Add(childNode);
            ...
            {
                bool isFirst = Children.Count/*ContainerContent.Count*/ == 0;
